...
- Dates: 10/23-24, 10/26-27
- Time: 8:30am to 11:30am ET

Breaks:

- Morning: 9:55am - 10:05am (skip if class agrees)


## Course Outline

- Day 1 - React Overview, Creating Components, Passing Data
- Day 2 - State and Controlled Components
- Day 3 - Component Composition
- Day 4 - React Topics + Unit Testing
